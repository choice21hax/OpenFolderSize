  ...
  <div class="col-xs-12">
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">OpenFolderSize</h3>
      </div>
      <div class="box-body">
        <p>
          OpenFolderSize adds on-demand folder size calculation to the client file manager for
        ...
        <p>
          ...
          choice21
          (<a href="https://choice21.site" target="_blank" rel="noreferrer">choice21.site</a>)
        </p>
      </div>
    </div>
  </div>
